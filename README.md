...
## Execution
1. Set the configuration file `src/config.ts`:
	```typescript
	interface Config {
...
3. While running:
	...
	* Open http://localhost:5173/ and log in with the above information. You can then create a wallet and send transactions within the app.
